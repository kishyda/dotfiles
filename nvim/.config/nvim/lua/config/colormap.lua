local function cs(colorscheme)
    ...
    local highlight_groups = {
        ...
        "DiagnosticUnderlineOk", "LspInlayHint", "HarpoonWindow", 
        "HarpoonBorder", "CmpBorder", "LspSignatureActiveParameter", 
        "RenderMarkdown_bgtofg_RenderMarkdownCode"," SpecialKey", "RenderMarkdownCodeInline", 
        "RenderMarkdownCode", "@markup.raw.delimiter.markdown", "Special",
        "SagaNormal"
    }
